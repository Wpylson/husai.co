...
<head>
    ...
    <meta name="description" content="Husai, Tecnologia & Inovações">
        ...
        <main class="container mb-auto">
            <div class="carousel carousel-main">
                <div class="carousel-cell">
                    <h3 class="mt-3 main-header-text-title"><span>O melhor provedor de domínios da região</span>seguro e garantido</h3>
            ...
            <div class="row justify-content-start second-pricing-table-container mr-tp-30">
                ...
                while ($ascCpaineldedic = mysqli_fetch_assoc($selplanoscpnalDedic)) {
                    ...
                    <div class="second-pricing-table">
                        ...
                        <a class="second-pricing-table-button" href="order.php?idProduto=<?php echo $ascCpaineldedic["id"].'& tipo=cpainel'; ?>" style="background: #F0E738; color: #93278F; border: none;">Adicionar ao Carrinho</a>
    ...
    <section class="padding-100-0-50 position-relative">
        <div class="container">
            ...
            <div class="button-row text-center">
                <a class="btn jango-color-btn" href="signup.php" style="background: #F0E738; color: #93278F;">crie uma nova conta agora</a>
            </div>
	...
	<section class="our-pertners padding-20-0 mr-tp-0">
      ...
      <div class="container">
        ...
        <div class="section-header" style=" margin-top: -90px;">
          ...
          <p>Conheça nossos clientes satisfeitos</p>
        </div>
        ...
        <div class="row no-gutters clients-wrap clearfix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="client-logo">
              <img src="bankya.png" class="img-fluid" alt="">
            </div>
          </div>
          
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="client-logo">
              <img src="log.png" class="img-fluid" alt="">
            </div>
          </div>
