            ...
            <form method="post">
                <div class="row justify-content-center">
                    ...
                    <div class="profile-img user-header">
                        ...
                        <p style="font-size: 10px;">Perfil do utilizador</p>
                    </div>
                </div>
                <!-- <div class="col-md-2">
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active row" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <div class="row user-info">
                                        ...
                                        <div class="col-md-12">
                                            <div class="field input-field">
                                                ...
                                                <p class="data-info" style=""><?php echo $ascCli["nome"]; ?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="field input-field">
                                                <p style="font-size: 12px;color: #000;margin: 0;"><em class="fa fa-globe" style="margin-right:5px"></em>Idioma</p>
                                                <p class="data-info" style=""><?php echo $ascCli["nome"]; ?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="field input-field">
                                                <p style="font-size: 12px;color: #000;margin: 0;"><em class="fa fa-globe-dollar" style="margin-right:5px"></em>Moeda</p>
                                                <p class="data-info" style=""><?php echo $ascCli["nome"]; ?></p>
                                            </div>
                                        </div>
                                    </div>
                               ...
                               <div class="row mt-20-mb-20">
                                    <div class="col-md-6">
                                   <a class="btn-profile" href="#">  <em class="fa fa-edit" style="margin-right:5px"></em>Editar Informações</a>
                                    </div>
                                    <div class="col-md-6">
                                   <a class="btn-profile" href="#">  <em class="fa fa-lock" style="margin-right:5px"></em>Alterar Palavra-passe</a>
                                    </div>
                               </div>
                            </div>
