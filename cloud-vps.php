            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="breadcrumb-hosting-pages row">
                        ...
                        <a class="col-md-3 active" href="cloud-vps.php">
                            <img src="img/svgs/clouds.svg" alt="#" />
                            <span class="sub-breadcrumb-host-title">nuvens VPS</span>
                        </a>

                        <a class="col-md-3" href="dedicated.php">
   ...
   <section class="padding-100-0-10 position-relative">
        <div class="container">
            <div class="row justify-content-center">
                <form class="col-md-4 custom-slider-plan-form">
                    <span class="custom-slider-plan-form-top-header" style="background: #93278F;">ESCOLHA SEU PLANO</span>
                    <div class="custom-slider-plan-form-header">
                        <span class="stokage"><b id="resellerEarnings">10</b>GB SSD</span>
                        <span class="price">AOA<b><span id="clientPrice">10</span>.00</b>/mo</span>
                        <span class="free-trial">free 7 days trial</span>
                    </div>
                    <div class="price-slider-input">
                        <input id="calculatorSlider" class="no-border" type="range" value="1" min="1" max="40" />
                    </div>

                    <ul class="custom-slider-plan-form-body">
                    ...
                    <button class="btn custom-slider-plan-form-order-button" type="submit" style="background: #F0E738; color: #93278F;border:none;">Criar uma conta gratuita</button>
                </form>
            </div>
