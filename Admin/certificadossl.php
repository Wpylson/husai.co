...
<body class="fixed-navigation" >
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="certificadossl.php">Certificado SSL</a></li>
        ...
        <div class="animated fadeInRight ecommerce" style="width: 98%; text-align: center;">
            <?php 
            if (isset($_POST["attplano"])) {
                ...
                $upd = "UPDATE `certificado_ssl` SET `preco`='$preco',`descricao`='$descricao',`dominio`='$dominio',`backups`='$backups',`cdn`='$cdn',`ssl`='$ssl',`ddos`='$ddos' WHERE id='$planoID' ";
                $cogupd = mysqli_query($conn,$upd);
                if ($cogupd) {
                    ?>
                     <div class="alert alert-info alert-dismissable">
                         <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                            Detalhes do plano de certificado SSl atualizado com sucesso.
                    </div>
                     <?php
                }
            }
           ...
           <?php 
                                    $selcpainel = mysqli_query($conn,"SELECT * FROM certificado_ssl ");
                                    while ($aschost = mysqli_fetch_assoc($selcpainel)) {
                                        ?>
                                          <div class="col-md-4" style="display: inline-block; cursor: pointer;">
                                        <div class="ibox">
                                            ...
                                            <div class="ibox-content product-box">
                                                ...
                                                <div class="product-desc">
                                                    ...
                                                    <p style="display: block;margin: auto; width: 100%;"><em class="fa fa-check"></em> <input  type="text" style="border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #ccc; width: 90%;" value="<?php echo $aschost["descricao"]; ?>" name="descricao"></p>
                                                     <p style="display: block;margin: auto; width: 100%;"><em class="fa fa-check"></em> <input  type="text" style="border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #ccc; width: 90%;" value="<?php echo $aschost["dominio"]; ?>" name="dominio"></p>
                                                     <p style="display: block;margin: auto; width: 100%;"><em class="fa fa-check"></em> <input  type="text" style="border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #ccc; width: 90%;" value="<?php echo $aschost["backups"]; ?>" name="backups"></p>
                                                     <p style="display: block;margin: auto; width: 100%;"><em class="fa fa-check"></em> <input  type="text" style="border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #ccc; width: 90%;" value="<?php echo $aschost["cdn"]; ?>" name="cdn"></p>
                                                      <p style="display: block;margin: auto; width: 100%;"><em class="fa fa-check"></em> <input  type="text" style="border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #ccc; width: 90%;" value="<?php echo $aschost["ssl"]; ?>" name="ssl"></p>
                                                      <p style="display: block;margin: auto; width: 100%;"><em class="fa fa-check"></em> <input  type="text" style="border-top: none; border-left: none; border-right: none; border-bottom: 1px solid #ccc; width: 90%;" value="<?php echo $aschost["ddos"]; ?>" name="ddos"></p>
                                                    </div>
