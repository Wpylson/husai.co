                                ...
                                <table class="table invoice-table">
                                    ...
                                    <tbody>
                                        ...
                                        $selCartk = mysqli_query($conn,"SELECT * FROM carrinho WHERE estado='sim' AND usuario='$user' ORDER BY id desc");
                                         while ($ascCart = mysqli_fetch_assoc($selCartk)) {
                                            ...
                                            if ($ascCart["tipo"]=="cpainel") {
                                                ...
                                                ?>
                                                 <tr>
                                                  <td><div><strong>Hospedagem Cpanel</strong></div>
                                                    <small><?php echo $ascHostcpainel["espaco"].', '.$ascHostcpainel["largura"].', '.$ascHostcpainel["subdominios"].', '.$ascHostcpainel["email"].', '.$ascHostcpainel["msyql"]; ?>.</small></td>
                                                    <td>1</td>
                                                ...
                                                ?>
                                                 <tr>
                                                  <td><div><strong><?php echo $ascCart["designacao"]; ?></strong></div>
                                                    <small style="color: green;"><em class="fa fa-check-circle"></em> <?php echo $ascCart["dominio"]; ?>.</small></td>
                                                    <td>1</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
                                                    <td>AOA 0,00</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
                                            ...
                                            ?>
                                             <tr>
                                                  <td><div><strong><?php echo $ascCert["nome"]; ?></strong></div>
                                                    <small> <?php echo $ascCert["descricao"]; ?>.</small></td>
                                                    <td>1</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
                                                    <td>AOA 0,00</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
                                        ...
                                        $ascVPS = mysqli_fetch_assoc($selVPS);
                                         ?>
                                         <tr>
                                                  <td><div><strong>Hospedagem VPS</strong></div>
                                                    <small> <?php echo $ascVPS["nome"].', '.$ascVPS["ram"].', '.$ascVPS["cpu"].', '.$ascVPS["transferencia"].', '.$ascVPS["sistema"]; ?>.</small></td>
                                                    <td>1</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
                                                    <td>AOA 0,00</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
                                    ...
                                    $ascVPS = mysqli_fetch_assoc($selVPS);
                                     ?>
                                     <tr>
                                                  <td><div><strong>Hospedagem Dedicada</strong></div>
                                                    <small>Domínio, Certificado SSL, E-mail personalizado, Assistencia Técnica.</small></td>
                                                    <td>1</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
                                                    <td>AOA 0,00</td>
                                                    <td>AOA <?php echo $ascCart["preco"]; ?></td>
