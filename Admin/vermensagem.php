...
$idms = $_GET["idms"];
$selmsgCa = mysqli_query($conn,"SELECT * FROM Mensagens WHERE id='$idms' ");
$ascMsgCap = mysqli_fetch_assoc($selmsgCa);
 ?>
 <!DOCTYPE html>
<html>
        ...
        <div class="animated fadeInRight ecommerce" style="width: 98%;">
            ...
            <div class="col-lg-9 animated fadeInRight">
                ...
                <div class="float-right tooltip-demo">
                    <a href="vermensagem.php?idms=<?php echo $idms; ?>" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Move to trash"><i class="fa fa-refresh"></i> </a>
                </div>
                <h2>
                    vizualização de mensagem
                </h2>
                <div class="mail-tools tooltip-demo m-t-md">


                    <h3>
                        <span class="font-normal">Titulo: </span><?php echo $ascMsgCap["titulo"]; ?>.
                    </h3>
                    <h5>
                        <span class="float-right font-normal"><?php echo $ascMsgCap["data"]; ?></span>
                        <span class="font-normal">De: </span><?php echo $ascMsgCap["email"]; ?>
                    </h5>
                    <?php 
                    if (isset($_POST["enviar"])) {
                        $resposta = $_POST["resposta"];
                        $upd = "UPDATE mensagens SET resposta='$resposta', estado='sim' WHERE id='$idms' ";
                        $updcog = mysqli_query($conn,$upd);
                        if ($updcog) {
                            ?>
                ...
                <div class="mail-box">
                     <div class="mail-body" style="border-bottom: 1px solid #ccc;">
                    <p>
                       <?php echo $ascMsgCap["mensagem"]; ?>
                        </p>
                </div>
                <div style="display: block; margin: auto; width: 100%; height: 140px; background: #f5f5f5; padding: 7px;">
                    <form method="POST">
                        <textarea rows="3" placeholder="Responder mensagem" name="resposta" class="form-control"></textarea>
                    <button class="btn btn-success pull-right" style="margin-top: 8px;" name="enviar">Enviar Resposta</button>
                    </form>
