            ...
            <div class="server-tabls-body">
                ...
                ?>
                    <div class="row justify-content-left server-tabls-row best-one">
                        ...
                        <div class="col-md-2"><a class="server-order-button" href="orderVerificar.php?idProduto=<?php echo $ascVps["id"] . '& tipo=vps'; ?>" style="background: #F0E738; color: #93278F;">peça agora</a></div>
                    </div>
                <?php
                }
                ?>
