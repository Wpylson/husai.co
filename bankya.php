...
<head>
    ...
    <title>Husai |Produto: Bankya</title>
            ...
            <div class="row justify-content-between" style="padding: 20px;background: #fff;">
                <div class="col-md-4 side-text-right-container side-text-plan-hosting">
                    ...
                    <ul class="web-hosting-options">
                        <li>
                            <p class="f-size16"><em class="fa fa-check-circle ok-circle-icon" style="margin-right:5px;"></em>Marketplace Escalável</p>
                        </li>
                        <li>
                            <p class="f-size16"><em class="fa fa-check-circle ok-circle-icon" style="margin-right:5px;"></em>Injectável</p>
                        </li>
                        <li>
                            <p class="f-size16"><em class="fa fa-check-circle ok-circle-icon" style="margin-right:5px;"></em>100% Seguro</p>
                        </li>
                        <li>
                            <p class="f-size16"><em class="fa fa-check-circle ok-circle-icon" style="margin-right:5px;"></em>Rápido</p>
                        </li>
                    </ul>
