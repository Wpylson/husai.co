...
<head>
    ...
    <title>Husai | Contacta-nos</title>
...
<body>
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="contact-us-social-icons">
                        ...
                        <a class="yb" href="#" style="background: #F0E738;"><i class="fab fa-youtube" style="color: #93278F;"></i></a>
                    </div>
                </div>
    ...
    <section class="padding-100-0">
        <div class="container">
            <h3 class="map-comment-area-title">Bem vindo ao Centro de Ajuda de Clientes Husai</h3>
            <p class="map-comment-area-text">é simplesmente um texto fictício da indústria tipográfica e de impressão. Lorem Ipsum tem sido o texto fictício padrão da indústria desde os anos 1500, quando um impressor desconhecido pegou uma cozinha de tipos e embaralhou-a para fazer um livro de espécimes de tipos.</p>
            ...
            <div class="row justify-content-center mr-tp-80">
                <div id="nav-tabContent" class="col-md-10 tab-content">
